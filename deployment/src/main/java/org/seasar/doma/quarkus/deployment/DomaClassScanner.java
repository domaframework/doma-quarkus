...
public class DomaClassScanner {
  ...
  private static final DotName ENTITY_TYPE_IMPLEMENTATION =
      DotName.createSimple(EntityTypeImplementation.class.getName());
  private static final DotName EMBEDDABLE_TYPE_IMPLEMENTATION =
      DotName.createSimple(EmbeddableTypeImplementation.class.getName());
  private static final DotName DOMAIN_TYPE_IMPLEMENTATION =
      DotName.createSimple(DomainTypeImplementation.class.getName());
